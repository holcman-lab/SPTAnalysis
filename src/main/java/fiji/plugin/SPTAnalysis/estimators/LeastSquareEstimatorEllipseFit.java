...
@XmlRootElement(name = "LeastSquareEstimatorEllipseFit")
@XmlAccessorType(XmlAccessType.FIELD)
public class LeastSquareEstimatorEllipseFit extends GridEstimator
{
	public LeastSquareEstimatorEllipseFit()
	{
		super();
	}

	public LeastSquareEstimatorEllipseFit(TrajectoryEnsemble trajs, VectorMap drift, ArrayList<int[]> nh,

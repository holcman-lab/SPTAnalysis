...
@XmlRootElement(name = "LeastSquareEstimatorEllipseNorm")
@XmlAccessorType(XmlAccessType.FIELD)
public class LeastSquareEstimatorEllipseNorm extends GridEstimator
{
	public LeastSquareEstimatorEllipseNorm()
	{
		super();
	}

	public LeastSquareEstimatorEllipseNorm(TrajectoryEnsemble trajs, VectorMap drift, ArrayList<int[]> nh,
	...
	public double estimateA()
	{
		...
		for (int[] gpos: this.nh)
		{
			...
			num += Utils.vnorm(new double[] {rot_pt[0] / Math.pow(ell.rad()[0], 2),
											 rot_pt[1] / Math.pow(ell.rad()[1], 2)}) * Utils.vnorm(rot_dr);
